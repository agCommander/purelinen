...
export const metadata: Metadata = {
  title: "Custom Made Placemats",
  description: "Custom made placemats and linen products",
}
...
export default function CustomMadePlacematsPage() {
  return (
    <>
      {/* Full-width hero image */}
      <div className="relative w-full aspect-[16/9] md:aspect-[21/9] mb-8 md:mb-6">
        <Image
          src="/images/content/custom-placemats-hero.jpg"
          alt="Custom Made Placemats"
          fill
          priority
      ...
      <Layout className="pt-30 pb-20 md:pt-47 md:pb-32">
        ...
        >
          <div className="space-y-6">
            ...
            <div className="my-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="flex flex-col items-center">
                  <img 
                    alt="placemats plain" 
                    src="https://purelinen.com.au/media/wysiwyg/custom/placemats01.jpg" 
                    className="max-w-full h-auto mb-4"
                    width={155}
                    height="auto"
                  />
                  <p className="text-center">Placemat - Plain</p>
                </div>
                <div className="flex flex-col items-center">
                  <img 
                    alt="placemats fringes" 
                    src="https://purelinen.com.au/media/wysiwyg/custom/placemats02.jpg" 
                    className="max-w-full h-auto mb-4"
                    width={155}
                    height="auto"
                  />
                  <p className="text-center">Placemat - with fringes</p>
                </div>
                <div className="flex flex-col items-center">
                  <img 
                    alt="placemats ruffles" 
                    src="https://purelinen.com.au/media/wysiwyg/custom/placemats03.jpg" 
                    className="max-w-full h-auto mb-4"
                    width={155}
                    height="auto"
                  />
                  <p className="text-center">Placemat - with ruffles</p>
                </div>
              </div>
            </div>
            ...
            {/* Size Options */}
            <div className="my-12">
              <p className="font-bold text-lg mb-4">Size Options</p>
              <p>30 x 50; 35 x 50;</p>
            ...
            <div className="my-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="flex justify-center">
                  <img 
                    alt="example" 
                    src="https://purelinen.com.au/media/catalog/product/n/a/na_planetearth_hero_04.jpg" 
                ...
                <div className="flex justify-center">
                  <img 
                    alt="example" 
                    src="https://purelinen.com.au/media/catalog/product/n/a/na_bistro_hero_01.jpg" 
                    className="my-5 max-w-full h-auto"
                    width={250}
                    height={375}
                  />
                ...
                <div className="flex justify-center">
                  <img 
                    alt="example" 
                    src="https://purelinen.com.au/media/catalog/product/n/a/na_bistro_02_800x.jpg" 
                    className="my-5 max-w-full h-auto"
                    width={250}
                    height={375}
                  />
