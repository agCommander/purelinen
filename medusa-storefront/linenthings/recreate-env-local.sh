...
# Script to recreate .env.local file for Linen Things storefront
# Run this from: medusa-storefront/linenthings/

echo "Creating .env.local file for Linen Things storefront..."
